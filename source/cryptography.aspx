<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="cryptography.aspx.cs" Inherits="Default12" Title="Cryptography" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                <div style="width:500px;float:left;">
                    <table align="left" border="0" cellpadding="2" cellspacing="2" style="width: 315px">
                        <tr>
                            <td colspan="2">
                                <h4>
